    ...
    for page in paginator.paginate():
        for item in page['items']:
            recommendations.append({
                ...
                'estimatedMonthlySavings': item.get('estimatedMonthlySavings', ""),
                'estimatedSavingsPercentage': item.get('estimatedSavingsPercentage', ""),
                'estimatedMonthlyCost': item.get('estimatedMonthlyCost', ""),
                'currencyCode': item.get('currencyCode', ""),
                'implementationEffort': item.get('implementationEffort', ""),
                'restartNeeded': item.get('restartNeeded', ""),
                'actionType': item.get('actionType', ""),
                'rollbackPossible': item.get('rollbackPossible', ""),
                ...
                'recommendationLookbackPeriodInDays': item.get('recommendationLookbackPeriodInDays', ""),
